...
if(isset($_POST['add_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_quantity) ||empty($product_description) ||empty($product_image)){
      ...
      $insert = "INSERT INTO products(name, price,quantity,description, image) VALUES('$product_name', '$product_price','$product_quantity','$product_description', '$product_image')";
