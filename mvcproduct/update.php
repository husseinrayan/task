...
if(isset($_POST['update_product'])){
   ...
   if(empty($product_name) || empty($product_price) || empty($product_quantity) ||empty($product_description) ||empty($product_image)){
      $message[] = 'please fill out all!';    
   }else{

      $update_data = "UPDATE products SET name='$product_name', price='$product_price', quantity='$product_quantity', description=' $product_description', image='$product_image'  WHERE id = '$id'";
